...
Once approved, Periodix-Planner will be available in the Obsidian Community Plugins directory:

1. Open **Settings** → **Community plugins**
2. Click **Browse** to open the community plugins browser
3. Search for **"Periodix-Planner"**
4. Click **Install**
...
4. Enter the repository URL: `Real1tyy/Periodix-Planner`
5. Click **Add Plugin**
...
1. Download the latest `main.js`, `manifest.json`, and `styles.css` from the [Releases page](https://github.com/Real1tyy/Periodix-Planner/releases)
2. Navigate to your vault's `.obsidian/plugins/` folder
3. Create a new folder named `periodix-planner`
...
1. Open **Settings** → **Community plugins**
2. Confirm **Periodix-Planner** is listed and enabled
3. You should see a **Periodix-Planner** settings tab in the main Settings page
4. Try the command **"Generate all periods for today"** from the command palette
...
For more help, see the [Troubleshooting Guide](/troubleshooting) or [open an issue on GitHub](https://github.com/Real1tyy/Periodix-Planner/issues).

---

**Next Step:** Once installed, check out the [Quick Start Guide](/quickstart) to configure and start using Periodix-Planner!
